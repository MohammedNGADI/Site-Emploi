            ...
            <?php
                if ($result_Rechrche->num_rows > 0) {
                    if($result_Rechrche->num_rows == 1){
                        echo "<div class='NbrOffreTouve'> Une offre </div> ";
                    }elseif($result_Rechrche->num_rows == 2){
                        echo "<div class='NbrOffreTouve'> Deux offres </div> ";
                    }elseif($result_Rechrche->num_rows == 3){
                        echo "<div class='NbrOffreTouve'> Trois offres </div> ";
                    }else{
                        echo "<div class='NbrOffreTouve'> $result_Rechrche->num_rows offres </div> ";
                    }
